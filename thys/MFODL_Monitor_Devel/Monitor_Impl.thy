...
function (in maux) (sequential) meinit0 :: "nat \<Rightarrow> Formula.formula \<Rightarrow> ('msaux, 'muaux) meformula" where
...
global_interpretation verimon_maux: maux valid_vmsaux init_vmsaux add_new_ts_vmsaux join_vmsaux
  ...
  and vmeinit0 = "maux.meinit0 (init_vmsaux :: _ \<Rightarrow> event_data vmsaux) (init_vmuaux :: _ \<Rightarrow> event_data vmuaux) :: _ \<Rightarrow> Formula.formula \<Rightarrow> _"
