  ...
  $ monpoly -sig test25.sig -formula test25_1.mfotl -log test25.log -verbose -nonewlastts
  ...
  $ monpoly -sig test25.sig -formula test25_2.mfotl -log test25.log -verbose -nonewlastts
  The analyzed formula is:
