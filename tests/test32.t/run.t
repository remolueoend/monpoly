  ...
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_1.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (3)
  @30 (time point 2): (0)

  $ echo 'v <- CNT y p(x,y)' > test_agg_empty_rel_2.mfotl
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_2.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (3)
  @30 (time point 2): (0)

  $ echo 'v <- SUM y p(x,y)' > test_agg_empty_rel_3.mfotl
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_3.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (6)
  @30 (time point 2): (0)

  $ echo 'v <- AVG y p(x,y)' > test_agg_empty_rel_4.mfotl
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_4.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (2)
  @30 (time point 2): (0)
  ...
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_15.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (6)
  @30 (time point 2): (6)

  $ echo 'v <- AVG y ONCE p(x,y)' > test_agg_empty_rel_16.mfotl
  $ monpoly -sig test_agg_empty_rel.sig -formula test_agg_empty_rel_16.mfotl -log test_agg_empty_rel.log -nonewlastts
  @10 (time point 0): (0)
  @20 (time point 1): (2)
  @30 (time point 2): (2)
  WARNING: AVG applied on empty relation! Resulting value is 0, by (our) convention.
