  ...
  $ monpoly -sig test24.sig -formula test24_1.mfotl -log test24.log -verbose -nonewlastts
  ...
  $ monpoly -sig test24.sig -formula test24_4.mfotl -log test24.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -sig test24.sig -formula test24_5.mfotl -log test24.log -verbose -nonewlastts
  The analyzed formula is:
