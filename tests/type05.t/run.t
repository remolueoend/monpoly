Type check LET formulas correctly
  ...
  $ monpoly -sig type05.sig -formula type05_2.mfotl -verbose -check -no_rw -debug typing 2>&1 | grep "Type error"
  Fatal error: exception Failure("Type error while evaluating term '\"\"': Actual type String is not compatible with expected type Int")
