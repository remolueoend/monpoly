  ...
  $ monpoly -verified -sig test18.sig -formula test18_1.mfotl -log test18.log -verbose -nonewlastts
  ...
  $ monpoly -verified -sig test18.sig -formula test18_2.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND a = (1 + b) + 2
  The sequence of free variables is: (a,b,c)
  At time point 0:
  ...
  $ monpoly -verified -sig test18.sig -formula test18_3.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND a + 1 = 1 + b
  The sequence of free variables is: (a,b,c)
  At time point 0:
  ...
  $ monpoly -verified -sig test18.sig -formula test18_4.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND a = b + c
  The sequence of free variables is: (a,b,c)
  At time point 0:
  ...
  $ monpoly -verified -sig test18.sig -formula test18_5.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND a + c = b + a
  The sequence of free variables is: (a,b,c)
  At time point 0:
  ...
  $ monpoly -verified -sig test18.sig -formula test18_6.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND x = (1 + b) + c
  ...
  $ monpoly -verified -sig test18.sig -formula test18_7.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND x = (a + b) + c
  The sequence of free variables is: (a,b,c,x)
  At time point 0:
  ...
  $ monpoly -verified -sig test18.sig -formula test18_8.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND x + 1 = b + c
  The sequence of free variables is: (a,b,c,x)
  ...
  $ monpoly -verified -sig test18.sig -formula test18_9.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
...
Note: division by zero is defined to be zero by VeriMon
  $ echo 'S(a,b,c) AND (x = a / b)' > test18_10.mfotl
  $ monpoly -verified -sig test18.sig -formula test18_10.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
    S(a,b,c) AND x = a / b
  The sequence of free variables is: (a,b,c,x)
  At time point 0:
  ...
  At time point 1:
  @200 (time point 1): ((10,0,1,0))

  $ echo 'S(a,b,c) AND NOT (a = b + 2)' > test18_11.mfotl
  $ monpoly -verified -sig test18.sig -formula test18_11.mfotl -log test18.log -verbose -nonewlastts
  The analyzed formula is:
