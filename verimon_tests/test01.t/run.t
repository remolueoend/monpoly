  ...
  $ monpoly -verified -sig test1.sig -formula test1_1.mfotl -log test1.log -verbose -nonewlastts
  ...
  $ monpoly -verified -sig test1.sig -formula test1_2.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x) OR Q(x)
  The sequence of free variables is: (x)
  At time point 0:
...
A domain-dependent formula:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_3.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x) OR Q(y)
  ...
  $ monpoly -verified -sig test1.sig -formula test1_4.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_5.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_6.mfotl -log test1.log -verbose -nonewlastts -nofilteremptytp
  The analyzed formula is:
    T()
  ...
  $ monpoly -verified -sig test1.sig -formula test1_7.mfotl -log test1.log -verbose -nonewlastts -nofilteremptytp
  The analyzed formula is:
    R(y,x)
  ...
  $ monpoly -verified -sig test1.sig -formula test1_8.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_9.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    NEXT[0,30] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_10.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    PREVIOUS[0,30] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_11.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_12.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_13.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_14.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_15.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_16.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_17.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_18.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_19.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_20.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_21.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_22.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_23.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x) SINCE[0,30] Q(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_24.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_25.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    0 = 0 SINCE[0,*) P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_26.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    ONCE[0,0] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_27.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    ONCE[0,10] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_28.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    ONCE[0,*) P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_29.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    ONCE[1,10] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_30.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    ONCE[1,9] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_31.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_32.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_33.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_34.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_35.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_36.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x) UNTIL[0,10] Q(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_37.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_38.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_39.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_40.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    P(x) UNTIL[1,9] Q(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_41.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_42.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_43.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_44.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_45.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    0 = 0 UNTIL[0,0] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_46.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    EVENTUALLY[0,0] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_47.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    EVENTUALLY[0,10] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_48.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    EVENTUALLY[1,10] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_49.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
    EVENTUALLY[1,9] P(x)
  The sequence of free variables is: (x)
  At time point 0:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_50.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
  ...
  $ monpoly -verified -sig test1.sig -formula test1_51.mfotl -log test1.log -verbose -nonewlastts
  The analyzed formula is:
