...
EVENT_RATES="1" 
INDEX_RATES="1"
LOG_LENGTH="50 75 100 150"
NUM_ADAPTATIONS='5/1/-x 0.3;-z x=10+1000,y=0,z=0,w=0 -x 0.1;-pA 0.01 -pB 0.495 -x 0.01;-pA 0.495 -pB 0.495 -x 0.005;-z x=2+1000,y=0,z=0,w=0 -x 0.2;-z x=10+1000,y=10+2000,z=0,w=0 -x 0.01'
WINDOW=10
...
info "=== Running Star-Linear-Triangle random experiments ==="
